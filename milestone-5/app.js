...
var generateUniqueURL = function () {
    return "".concat(window.location.origin, "/resume/").concat(Date.now());
};
...
form.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
    var name, email, phone, education, workExperience, skills, profilePicFile, handleProfilePic, populateResume, profilePicSrc, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                handleProfilePic = function (file) {
                ...
                populateResume = function (profilePicSrc) {
                    ...
                    var resumeURL = generateUniqueURL();
